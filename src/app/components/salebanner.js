...
<div className="grid grid-cols-2 gap-4 w-full px-2 sm:px-4 max-w-4xl mx-auto">
  ...
  <div className="relative h-64 overflow-hidden shadow-lg group">
    ...
    <div className="absolute inset-0 bg-gray-500/50 p-2 sm:p-4 flex flex-col justify-center items-start w-full">
      <h3 className="text-black text-xs sm:text-xl font-semibold mb-2 w-full ">New Arrivals</h3>
  ...
  <div className="relative h-64 overflow-hidden shadow-lg group">
    ...
    />
    <div className="absolute inset-0 bg-gray-500/50 p-2 sm:p-4 flex flex-col justify-center items-start w-full">
      <h3 className="text-black text-xs sm:text-xl font-semibold mb-2 w-full ">Hot Sale</h3>
      <p className="text-black text-xs sm:text-base mb-4 w-full ">Limited time offers!</p>
